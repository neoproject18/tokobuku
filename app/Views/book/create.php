            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('book/create') ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-3">
                            <input type="number" class="form-control <?= $validation->hasError('stock') ? 'is-invalid' : '' ?>" id="stock" name="stock" min="0" value="<?= old('stock') ?? 0 ?>">
                            <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control <?= $validation->hasError('discount') ? 'is-invalid' : '' ?>" id="discount" name="discount">
                            <div id="validationServer03Feedback" class="invalid-feedback">
